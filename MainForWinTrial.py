...
gsm = io.Serial("COM3",9600, timeout=0.5) # change the COM port number according to the one your system has given to the GSM module, you can see that via termite or any similar terminal
gsm.flush()
